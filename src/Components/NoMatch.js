    ...
    <div>
      ...
      <div className="d-flex justify-content-center align-item-center w-100">
        <input
          type="text"
          value={navigateing}
          onChange={(e) => setNavigateing(e.target.value)}
          placeholder="Path Looking for"
          className="px-5 py-1 text-start"
        />
      </div>
