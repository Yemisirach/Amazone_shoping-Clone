...
const CheckoutProduct = ({
  ...
  return (
    <div className="sup m-2 d-flex m-2 p-4 w-100 bg-white modal-dialog-centered mx-3 my-3">
      <div className="left">
        <div className="d-flex">
          <div className={`product_inf mb-3 fw-bolder m-2 ${rip}`}>
            <img
              className="w-100 mb-3 carton d-flex my-auto ms-4 pe-5"
              src={img_1}
              alt="Amazon_Product"
            />
          </div>
          <div className={`product_inf mb-3 fw-bolder m-2 ${zip}`}>
            <img
              className="w-75 pb-5 ss d-flex my-auto ms-4 pe-1"
              src={img_2}
              alt="Amazon_Product"
            />
          </div>
          <div className={`product_inf mb-3 fw-bolder m-2 ${zip}`}>
            <img
              className="w-100 mb-3 ss d-flex my-auto ms-4 pe-1"
              src={img_3}
              alt="Amazon_Product"
            />
          </div>
      ...
      <button
        className={`${
          !hideButton ? "fw-bolder d-flex my-auto balon mx-auto" : "d-none"
        }`}
        onClick={RemoveItems}
      >
        Remove from basket
