      ...
      <div className="sheks">
        <div className="left ">
          <div className="log pt-5 bg-white vh-100 d-flex align-items-center flex-column">
            <div className="login__container d-flex flex-column rounded-2 p-4">
              ...
              <form>
                ...
                <button
                  type="submit"
                  onClick={Signing}
                  className="rounded-1 w-100 border mt-2"
                >
                  Continue
                </button>
              </form>
              ...
              <ul>
                <li>
                  <Link to="/" className="text-decoration-none cont">
                    Need help?
                  </Link>
                </li>
              </ul>
            ...
            <button
              className="border rounded-1 px-5 mt-2 registar__btn"
              onClick={Register}
            >
